class PlacesController < ApplicationController
  ...
  def get_locations
   # binding.pry
    url = "https://maps.googleapis.com/maps/api/place/naerbysearch/json?location=#{params[:latitude]},#{params[:longtitude]}&radius=500&key=#{Rails.application.credentials[Rails.env.to_sym][:google_places_key]}"
